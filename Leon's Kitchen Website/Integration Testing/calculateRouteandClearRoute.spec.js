...
describe('Calculate Route and Clear Route', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('Calculate Route and Clear Route', async function() {
    ...
    // await driver.findElement(By.css(".pac-target-input")).sendKeys("hapugala, galle")
    // {
